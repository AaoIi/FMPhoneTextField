...
class CountriesViewController: UIViewController,UITextFieldDelegate{
    ...
    private let searchTextAllignment : NSTextAlignment = .center
    ...
    convenience init(delegate:CountriesDelegate?,language:language,isCountryCodeHidden:Bool = false) {
        self.init(nibName:"CountriesViewController", bundle:Bundle.getFrameworkBundle())
    ...
    private func setupViews(){
        ...
        self.searchTextField.textAlignment = searchTextAllignment
        ...
        // tableview related
        self.tableView.register(UINib(nibName: "CountryCell", bundle: Bundle.getFrameworkBundle()), forCellReuseIdentifier: countryCellIdentifier)
